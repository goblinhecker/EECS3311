...
extern void F863_6979(EIF_REFERENCE);
extern EIF_TYPED_VALUE F863_6980(EIF_REFERENCE);
extern EIF_TYPED_VALUE F863_6981(EIF_REFERENCE);
...
extern void F863_7673(EIF_REFERENCE, int);
...
void F863_6979 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 862, Current, 0, 0, 12621);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(862, Current, 12621);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4909, 0xF800035F, 0); /* default_board */
	
	tr1 = RTLNSMART(eif_non_attached_type(RTWCT(4909, dtype, Dftype(Current))));
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(4925, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(4909, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 4910, 0xF800035F, 0); /* easy_board */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4910, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 4911, 0xF800035F, 0); /* cross_board */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4911, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 4912, 0xF800035F, 0); /* plus_board */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4912, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(5);
	RTDBGAA(Current, dtype, 4913, 0xF800035F, 0); /* pyramid_board */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4913, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(6);
	RTDBGAA(Current, dtype, 4914, 0xF800035F, 0); /* arrow_board */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4914, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(7);
	RTDBGAA(Current, dtype, 4915, 0xF800035F, 0); /* diamond_board */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4915, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	RTHOOK(8);
	RTDBGAA(Current, dtype, 4916, 0xF800035F, 0); /* skull_board */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4921, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(14);
	RTDBGAA(Current, dtype, 4922, 0xF80000DB, 0); /* arrow_board_out */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4922, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(15);
	RTDBGAA(Current, dtype, 4923, 0xF80000DB, 0); /* diamond_board_out */
	...
	*(EIF_REFERENCE *)(Current + RTWA(4923, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(16);
	RTDBGAA(Current, dtype, 4924, 0xF80000DB, 0); /* skull_board_out */
...
EIF_TYPED_VALUE F863_6980 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F863_6981 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F863_7673 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 862, Current, 0, 7672);
	RTSA(dtype);
	RTME(dtype, 0);
