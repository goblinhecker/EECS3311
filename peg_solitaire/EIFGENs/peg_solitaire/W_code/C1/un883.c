...
extern void F883_7192(EIF_REFERENCE);
extern EIF_TYPED_VALUE F883_7193(EIF_REFERENCE);
...
void F883_7192 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 882, Current, 0, 0, 12806);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F883_7193 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 882, Current, 0, 0, 12807);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
