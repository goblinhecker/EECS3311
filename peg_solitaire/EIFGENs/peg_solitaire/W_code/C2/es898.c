...
extern void F898_7295(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F898_7296(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F898_7297(EIF_REFERENCE);
extern EIF_TYPED_VALUE F898_7298(EIF_REFERENCE);
extern EIF_TYPED_VALUE F898_7299(EIF_REFERENCE);
...
void F898_7295 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 897, Current, 0, 2, 12905);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 12905);
	RTCC(arg1, 897, l_feature_name, 1, eif_attached_type(219));
	{
		...
		RTCC(arg2, 897, l_feature_name, 2, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
body:;
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5195, 0xF80000F1, 0); /* case */
	
	RTAR(Current, arg2);
	*(EIF_REFERENCE *)(Current + RTWA(5195, dtype)) = (EIF_REFERENCE) RTCCL(arg2);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 5191, 0xF80000DB, 0); /* case_name */
	
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(5191, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 5193, 0xF80000DB, 0); /* violation_tag */
	
	tr1 = RTMS_EX_H("",0,0);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5193, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 5197, 0xF80000DB, 0); /* expected_tag_name */
	
	tr1 = RTMS_EX_H("NONE",4,1313820229);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + RTWA(5197, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 5192, 0xF80000DB, 0); /* bookmark_name */
...
void F898_7296 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 897, Current, 1, 3, 12906);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(897, Current, 12906);
	RTCC(arg1, 897, l_feature_name, 1, eif_attached_type(219));
	{
		static EIF_TYPE_INDEX typarr0[] = {241,0xFF11,0,0xFF11,0xFFF9,0,173,0xFFFF};
		EIF_TYPE_INDEX typres0;
	...
	RTCC(arg3, 897, l_feature_name, 3, eif_attached_type(219));
	RTIV(Current, RTAL);
...
#define ur2 ur2x.it_r
	...
	ur1 = RTCCL(tr1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5197, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	ur2 = RTCCL(tr2);
	...
	if (tb1) {
		...
		*(EIF_BOOLEAN *)(Current + RTWA(5189, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		...
		RTHOOK(7);
		RTDBGAA(Current, dtype, 5190, 0x04000000, 1); /* contract_violated */
		...
		*(EIF_REFERENCE *)(Current + RTWA(5193, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
		RTHOOK(10);
		RTDBGAA(Current, dtype, 5194, 0x10000000, 1); /* violation_type */
		
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1231, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(5194, dtype)) = (EIF_INTEGER_32) ti4_1;
	}
	RTHOOK(11);
...
EIF_TYPED_VALUE F898_7298 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 897, Current, 0, 0, 12908);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(897, Current, 12908);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F898_7299 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
