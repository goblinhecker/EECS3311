...
extern void F885_7194(EIF_REFERENCE);
extern EIF_TYPED_VALUE F885_7195(EIF_REFERENCE);
...
void F885_7194 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 884, Current, 0, 0, 12808);
	RTSA(Dtype(Current));
	RTSC;
...
/* {UNOCCUPIED_SLOT}.out */
EIF_TYPED_VALUE F885_7195 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 884, Current, 0, 0, 12809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(884, Current, 12809);
	RTIV(Current, RTAL);
	RTHOOK(1);
