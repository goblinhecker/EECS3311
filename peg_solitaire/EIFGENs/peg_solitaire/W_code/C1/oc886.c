...
extern void F886_7196(EIF_REFERENCE);
extern EIF_TYPED_VALUE F886_7197(EIF_REFERENCE);
...
/* {OCCUPIED_SLOT}.make */
void F886_7196 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 885, Current, 0, 0, 12810);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(885, Current, 12810);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
/* {OCCUPIED_SLOT}.out */
EIF_TYPED_VALUE F886_7197 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 885, Current, 0, 0, 12811);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(885, Current, 12811);
	RTIV(Current, RTAL);
	RTHOOK(1);
