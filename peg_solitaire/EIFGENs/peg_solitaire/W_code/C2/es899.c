...
extern void F899_7300(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F899_7301(EIF_REFERENCE);
extern EIF_TYPED_VALUE F899_7302(EIF_REFERENCE);
extern EIF_TYPED_VALUE F899_7303(EIF_REFERENCE);
...
void F899_7300 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 898, Current, 0, 2, 12910);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(898, Current, 12910);
	RTCC(arg1, 898, l_feature_name, 1, eif_attached_type(219));
	{
		...
		RTCC(arg2, 898, l_feature_name, 2, eif_attached_type(typres0));
	}
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F899_7301 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 898, Current, 3, 0, 12911);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(898, Current, 12911);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		ur1 = tr1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4319, "item", loc2))(loc2, ur1x)).it_b);
		if (tb1) {
			RTHOOK(4);
...
EIF_TYPED_VALUE F899_7302 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 898, Current, 0, 0, 12912);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(898, Current, 12912);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F899_7303 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
