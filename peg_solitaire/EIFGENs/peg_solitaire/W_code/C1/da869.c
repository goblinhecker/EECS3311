...
extern EIF_TYPED_VALUE F869_7048(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7049(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7050(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7051(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7052(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7053(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7054(EIF_REFERENCE);
extern EIF_TYPED_VALUE F869_7055(EIF_REFERENCE);
...
EIF_TYPED_VALUE F869_7048 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F869_7048,12686,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F869_7049)
EIF_TYPED_VALUE F869_7049 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 12686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(868, Current, 12686);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {242,0xFF11,219,0xFFFF};
	...
	*((EIF_REFERENCE *)tr2+6) = (EIF_REFERENCE) tr3;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(1693, "compare_objects", Result))(Result);
	RTVI(Current, RTAL);
	RTRS;
	RTOTE;
	RTHOOK(3);
...
RTOID (F869_7050)
EIF_TYPED_VALUE F869_7050 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 12687);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(868, Current, 12687);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F9, 0,0); /* Result */
...
RTOID (F869_7051)
EIF_TYPED_VALUE F869_7051 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 12688);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(868, Current, 12688);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F9, 0,0); /* Result */
...
RTOID (F869_7052)
EIF_TYPED_VALUE F869_7052 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 868, Current, 0, 0, 12689);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(868, Current, 12689);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F9, 0,0); /* Result */
...
EIF_TYPED_VALUE F869_7053 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F869_7053,12691,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F869_7054 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F869_7054,12692,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F869_7055 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F869_7055,12693,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit869 (void)
{
	GTCX
	RTOTS (7048,F869_7048)
	RTOTS (7049,F869_7049)
	RTOTS (7050,F869_7050)
	RTOTS (7051,F869_7051)
	RTOTS (7052,F869_7052)
	RTOTS (7053,F869_7053)
	RTOTS (7054,F869_7054)
	RTOTS (7055,F869_7055)
}
