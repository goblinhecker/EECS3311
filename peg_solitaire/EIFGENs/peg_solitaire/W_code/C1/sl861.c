...
extern void F861_7672(EIF_REFERENCE, int);
...
void F861_7672 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 860, Current, 0, 7671);
	RTSA(dtype);
	RTME(dtype, 0);
...
{
	GTCX
	RTOTS (6976,F861_6976)
	RTOTS (6977,F861_6977)
	RTOTS (6978,F861_6978)
}
